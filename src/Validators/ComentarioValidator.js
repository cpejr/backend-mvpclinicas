...
const create = validateRequest({
  body: z.object({
    comentario: z.object({
      "Qual foi o cargo exercido no local?": z.string().optional(),
      ...
      "No cargo exercido você era responsável por quais outros cargos?": z.string().optional(),
      "Qual a área de abrangência do Local": z.string().optional(),
      "Como era a organização do local (Divisão em blocos e áreas)?": z.string().optional(),
